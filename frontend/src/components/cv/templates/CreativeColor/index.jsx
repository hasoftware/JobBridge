...
export default function CreativeColor({ data }) {
    ...
    return (
        <div className="tpl-creative-color">
            <header className="cv-banner">
                ...
                <div className="cv-contact">
                    ...
                    {personal.address && <span className="cv-contact-item">{personal.address}</span>}
                    {personal.date_of_birth && <span className="cv-contact-item">Ngày sinh: {formatDate(personal.date_of_birth)}</span>}
                    {links.map((l, i) => (
                        <span key={i} className="cv-contact-item">{l.label || 'Link'}: {l.url}</span>
                    ))}
                </div>
            </header>
